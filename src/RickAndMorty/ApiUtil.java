...
public class ApiUtil {
    ...
    /*
     * CLASE de UTILERIA para consumir una API y transformar de formato JSON a
     * Character
     * NOTA> No ocupan entender todo el proceso, solo ocupan saber que al ejecutar
     * la
     * funcion getCharacterById y enviarle un numero identificador como parametro
     * regresara un Objeto de tipo Character con todas los atributos (Variables) de
     * dicho
     * personaje.
    ...
    private static Character parseCharacter(String json) {
        ...
        character.setImage(getValue(json, "image"));
